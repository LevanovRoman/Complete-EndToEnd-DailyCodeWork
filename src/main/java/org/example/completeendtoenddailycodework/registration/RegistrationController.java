...
import org.example.completeendtoenddailycodework.event.RegistrationCompleteEvent;
import org.example.completeendtoenddailycodework.event.listener.RegistrationCompleteEventListener;
import org.example.completeendtoenddailycodework.registration.password.IPasswordResetTokenService;
import org.example.completeendtoenddailycodework.registration.password.PasswordResetTokenService;
import org.example.completeendtoenddailycodework.registration.token.VerificationToken;
import org.example.completeendtoenddailycodework.registration.token.VerificationTokenRepository;
import org.example.completeendtoenddailycodework.registration.token.VerificationTokenService;
import org.example.completeendtoenddailycodework.user.IUserService;
import org.example.completeendtoenddailycodework.user.User;
import org.example.completeendtoenddailycodework.utility.UrlUtil;
